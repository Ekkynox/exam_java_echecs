...
import echec.models.pieces.*;
import echec.models.plateau.Case;
import echec.models.plateau.Echiquier;
...
public class Game {
    ...
    public Game() {
        ...
        if(Objects.equals(n1, "")) n1 = "Joueur blanc";
        else data.getListJoueurs().add(n1);

        System.out.println("Nom du joueur noir : ");
        String n2 = entree.nextLine();
        if(Objects.equals(n2, "")) n2 = "Joueur noir";
        else data.getListJoueurs().add(n2);
    ...
    private void initialisation() {
        ...
        System.out.println("Joueurs d'échec :\n" + data.getListJoueurs());
        String w;
        do {
